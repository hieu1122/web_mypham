        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-7">
                <div class="form-group">
                    ...
                    <textarea class="form-control form" rows='3' name="default_delivery_address" style="resize: none; "></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group d-flex justify-content-between">
                    <a href="javascript:void()" id="login-show">Đã đăng ký tài khoản?</a>
