            ...
            <div class="col-md-9">
                <div class="container-fluid p-0">
                    <?php if (isset($_GET['search'])) : ?>
                        <h4 class="text-center py-5"><b>Kết quả tìm kiếm cho '<?php echo $_GET['search'] ?>'</b></h4>
                    <?php endif; ?>
                                ...
                                <a class="card product-item text-reset text-decoration-none" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="">
                                            ...
                                            <!-- Product price-->
                                            <span><b>Giá: </b><?php echo $price ?>&#8363;</span>
                                        </div>
                                        <p class="m-0"><small>Thương hiệu: <?php echo $row['bname'] ?></small></p>
                                        <p class="m-0"><small>Danh mục: <?php echo $row['category'] ?></small></p>
                                    </div>
                                </a>
                            </div>
                        <?php endwhile; ?>
