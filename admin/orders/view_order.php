    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p>Trạng thái thanh toán: <?php echo $paid == 0 ? '<span class="badge badge-light text-dark border px-3 rounded-pill">Unpaid</span>' : '<span class="badge badge-success px-3 rounded-pill">Paid</span>' ?>
